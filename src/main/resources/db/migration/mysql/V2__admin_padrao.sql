...
VALUES (NULL, '82198127000121', CURRENT_DATE(), CURRENT_DATE(), 'Tribunal de Justiça');
...
VALUES (NULL, '16248890935', CURRENT_DATE(), CURRENT_DATE(), 'admin@empresa.com.br', 'ADMIN', 'ROLE_ADMIN', NULL, NULL, 
